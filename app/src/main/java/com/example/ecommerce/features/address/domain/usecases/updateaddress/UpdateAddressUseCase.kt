...
class UpdateAddressUseCase @Inject constructor(val repository: AddressRepository) :
    ...
    override suspend fun invoke(id: Int, customerAddressParams: AddressRequestEntity): UpdateAddressResponseEntity {
     return   repository.updateAddress(id = id, customerAddressParams = customerAddressParams)
    }
