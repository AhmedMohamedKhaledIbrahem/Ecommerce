...
class SignUpActivity : AppCompatActivity() {
    ...
    private fun signUpAuthentication() {
        ...
        authenticationObserver = Observer { state ->
            when (state) {
                is UiState.Loading -> {
                ...
                is UiState.Success -> {
                    ...
                    Toast.makeText(this, "${state.data},check your email", Toast.LENGTH_SHORT)
                        .show()
                    ...
                    val intent = Intent(this, CheckVerificationCodeActivity::class.java).apply {
        ...
        authenticationViewModel.authenticationState.observe(this, authenticationObserver)
    }
