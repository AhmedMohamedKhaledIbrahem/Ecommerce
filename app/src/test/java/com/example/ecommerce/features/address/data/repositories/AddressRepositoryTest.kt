...
//        verify(localDataSource).updateAddress(addressRequestParams = tUpdateAddressResponseModel)
//    }
//
//    @Test
...
//        verify(localDataSource, never()).updateAddress(addressRequestParams = tUpdateAddressResponseModel)
//    }
//
//    @Test
...
//        whenever(localDataSource.getAddress(id = 1)).thenReturn(tCustomerAddressEntity)
//        val result = repository.getAddress(id = 1)
...
//            whenever(remoteDataSource.getAddress()).thenReturn(tUpdateAddressResponseModel)
//            whenever(localDataSource.updateAddress(addressRequestParams = tUpdateAddressResponseModel)).thenReturn(
//                Unit
//            )
//            whenever(localDataSource.getAddress(id = 1)).thenReturn(tCustomerAddressEntity)
//            val result = repository.getAddress(id = 1)
...
//            verify(localDataSource).updateAddress(addressRequestParams = tUpdateAddressResponseModel)
//            verify(localDataSource).getAddress(id = 1)
//        }
//
//    @Test
...
//        verify(localDataSource, never()).updateAddress(tUpdateAddressResponseModel)
//        verify(localDataSource, never()).getAddress(id = 1)
//    }
//
//    @Test
...
//            )
//            whenever(remoteDataSource.getAddress()).thenReturn(tUpdateAddressResponseModel)
//            whenever(localDataSource.getAddress(1)).thenReturn(tCustomerAddressEntity)
//            val result = repository.checkUpdateAddress()
//            assertEquals(tCustomerAddressEntity, result)
//            verify(localDataSource).updateAddress(tUpdateAddressResponseModel)
//        }
//
...
//            tCheckUpdateAddressResponseModel
//        )
//        whenever(localDataSource.getAddress(1)).thenThrow(FailureException(tErrorMessage))
//        val exception = assertFailsWith<Failures.CacheFailure> {
//            repository.checkUpdateAddress()
//        }
//        assert(exception.message == tErrorMessage)
