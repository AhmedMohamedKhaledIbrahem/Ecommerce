...
class AddressMapperTest {
    ...
    private val tAddressResponseEntity = AddressResponseEntity(
        userId = 1,
    ...
    fun `should map AddressResponseModel to AddressResponseEntity`() = runTest {
        ...
        val tAddressResponseModel = fixture("address.json").run {
            Gson().fromJson(this, AddressResponseModel::class.java)
        }
        val result = AddressMapper.mapToEntity(model = tAddressResponseModel)
        assertEquals(tAddressResponseEntity, result)
    }
